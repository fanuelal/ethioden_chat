...
const emailed = currentUser.email;
console.log(emailed)
console.log(currentP)
  ...
  const submitFormHandler = async(e) =>{
    e.preventDefault();
      ...
      const response =  await axiosInstance.post('/auth', {emailed , currentP});

      console.log(response.data.data)
      if (response.data.success) {
        await axiosInstance.patch(`/employee/${currentUser.userId}`,{"password": newPassword});
        console.log(response.data.data)}
      alert("success")
    }
   catch (err) {
